...
class CI_Email {
	...
	var	$smtp_host		= "mail.raycocopiers.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "pjackson@raycocopiers.com";		// SMTP Username
	var	$smtp_pass		= "Rayco6900";		// SMTP Password
