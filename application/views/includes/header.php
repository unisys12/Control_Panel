	...
	<header class="small-8 columns">
		...
		<nav class="panel radius">
			<ul>
				...
				<li><span class="icon-cars" data-icon=""> </span><?php echo anchor('mileage', 'Mileage'); ?></li>
				<li><span class="icon-clock" data-icon=""> </span><?php echo anchor('timesheet', 'Timesheet'); ?></li>
			</ul>
		</nav>
	</header>
</div>